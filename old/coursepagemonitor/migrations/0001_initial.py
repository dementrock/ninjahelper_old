...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CoursePageMonitor'
        db.create_table('coursepagemonitor_coursepagemonitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='monitored_course_page', to=orm['community.UserProfile'])),
            ...
            ('hash_data', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('coursepagemonitor', ['CoursePageMonitor'])


    def backwards(self, orm):
        
        # Deleting model 'CoursePageMonitor'
        db.delete_table('coursepagemonitor_coursepagemonitor')
    ...
    models = {
        ...
        'coursepagemonitor.coursepagemonitor': {
            'Meta': {'object_name': 'CoursePageMonitor'},
            'hash_data': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shortname': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '100'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'monitored_course_page'", 'to': "orm['community.UserProfile']"})
        },
    ...
    complete_apps = ['coursepagemonitor']
