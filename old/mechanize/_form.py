...
def ParseResponseEx(response, file_wrapper=None,
...
def ParseFileEx(file, base_uri, file_wrapper=None,
                select_default=False,
                form_parser_class=FormParser,
                request_class=_request.Request,
                entitydefs=None,
...
def ParseResponse(response, response_wrapper=None, *args, **kwds):
    ...
    """
    return _ParseFileEx(response, response.geturl(), response_wrapper, *args, **kwds)[1:]

def ParseFile(file, base_uri, file_wrapper=None, *args, **kwds):
    ...
    """
    return _ParseFileEx(file, base_uri, file_wrapper=file_wrapper, *args, **kwds)[1:]

def _ParseFileEx(file, base_uri, file_wrapper=None, 
                 select_default=False,
                 ignore_errors=False,
                 form_parser_class=FormParser,
                 request_class=_request.Request,
