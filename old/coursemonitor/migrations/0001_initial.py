...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CourseMonitor'
        db.create_table('coursemonitor_coursemonitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='monitored_course', to=orm['community.UserProfile'])),
            ('ccn', self.gf('django.db.models.fields.IntegerField')(max_length=100)),
            ('current_enroll', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('enroll_limit', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('current_waitlist', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('waitlist_limit', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('has_waitlist', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('all_full', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_first_time', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('coursemonitor', ['CourseMonitor'])


    def backwards(self, orm):
        
        # Deleting model 'CourseMonitor'
        db.delete_table('coursemonitor_coursemonitor')
    ...
    models = {
        ...
        'coursemonitor.coursemonitor': {
            'Meta': {'object_name': 'CourseMonitor'},
            'all_full': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ccn': ('django.db.models.fields.IntegerField', [], {'max_length': '100'}),
            'current_enroll': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'current_waitlist': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'enroll_limit': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'has_waitlist': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_first_time': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'monitored_course'", 'to': "orm['community.UserProfile']"}),
            'waitlist_limit': ('django.db.models.fields.IntegerField', [], {'default': '-1'})
        },
