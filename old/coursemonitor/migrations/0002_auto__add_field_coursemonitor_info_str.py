...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseMonitor.info_str'
        db.add_column('coursemonitor_coursemonitor', 'info_str', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CourseMonitor.info_str'
        db.delete_column('coursemonitor_coursemonitor', 'info_str')
    ...
    models = {
        ...
        'coursemonitor.coursemonitor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info_str': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
