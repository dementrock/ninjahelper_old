...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('community_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='profile', unique=True, to=orm['auth.User'])),
            ('ninjacourses_password', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('is_main_schedule_imported', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_friend_list_imported', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_friend_schedule_imported', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_phone_set', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_email_set', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('url_as_friend', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('realname', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('cellphone', self.gf('django.db.models.fields.CharField')(default='0', max_length=30, blank=True)),
            ('cell_mail', self.gf('django.db.models.fields.CharField')(default='txt.att.net', max_length=100, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('email_to_verify', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('email_short_code', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True)),
            ('email_verification_code', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
        ))
        db.send_create_signal('community', ['UserProfile'])

        # Adding M2M table for field friend on 'UserProfile'
        db.create_table('community_userprofile_friend', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm['community.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm['community.userprofile'], null=False))
        ))
        db.create_unique('community_userprofile_friend', ['from_userprofile_id', 'to_userprofile_id'])


    def backwards(self, orm):
        
        # Deleting model 'UserProfile'
        db.delete_table('community_userprofile')

        # Removing M2M table for field friend on 'UserProfile'
        db.delete_table('community_userprofile_friend')
