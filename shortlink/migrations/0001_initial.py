...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shortlink_shortlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shortlink', to=orm['community.UserProfile'])),
        ...
        db.send_create_signal('shortlink', ['ShortLink'])


    def backwards(self, orm):
        
        # Deleting model 'ShortLink'
        db.delete_table('shortlink_shortlink')
    ...
    models = {
        ...
        'shortlink.shortlink': {
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shortlink'", 'to': "orm['community.UserProfile']"})
        }
    }

    complete_apps = ['shortlink']
